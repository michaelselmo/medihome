function buildPatientHtml(data) {
  const p = (v, fb) => (v && v !== 'undefined' && v !== 'null' ? v : (fb || '---'));
...
<title>Confirmacion de cita - MediHome</title>
</head>
          ...
          <tr>
            <td style="background-color:#ffffff;padding:28px 30px 20px">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="font-size:14px;color:#64748b;padding-top:2px;font-weight:400;letter-spacing:0.3px">Servicios M&eacute;dicos a Domicilio</td>
                </tr>
              </table>
            </td>
          </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="border-radius:8px;background-color:#25D366">
                          <a href="https://wa.me/18299017488?text=Hola%20MediHome%2C%20mi%20c%C3%B3digo%20es%20${p(data.codigo_cita)}" target="_blank" style="display:inline-block;padding:12px 28px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:8px">Contactar por WhatsApp</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="background-color:#f8fafc;padding:20px 30px;border-top:1px solid #e2e8f0;text-align:center">
              <table role="presentation" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                  <td style="font-size:11px;color:#94a3b8;padding-top:2px">Servicios M&eacute;dicos a Domicilio</td>
                </tr>
                <tr>
